"""Worker process for the ReturnProcessingWorkflow workflow.
...
async def main() -> None:
    ...
    worker = Worker(
        ...
        activities=[authorise_return, receive_returned_item, issue_refund, cancel_refund, revoke_return_authorisation],
    )
