...
async def test_stepthrough() -> None:
    ...
    try:
        async with Worker(
            ...
            activities=[pick_items, pack_shipment, dispatch_shipment, capture_payment, wait_for_carrier_pickup, unpack_shipment, ],
            ...
            await handle.signal("carrier_picked_up", args=[])
