# EcommerceOrderWorkflow (generated Temporal workflow)
...
| `workflow.py` | `@workflow.defn` orchestration: `EcommerceOrderWorkflow` |
...
`EcommerceOrderWorkflow` execution and prints its result. Open the Web UI at
