# FulfilmentWorkflow (generated Temporal workflow)
...
| `workflow.py` | `@workflow.defn` orchestration: `FulfilmentWorkflow` |
...
`FulfilmentWorkflow` execution and prints its result. Open the Web UI at
