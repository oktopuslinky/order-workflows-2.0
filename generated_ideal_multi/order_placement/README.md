# OrderPlacementWorkflow (generated Temporal workflow)
...
| `workflow.py` | `@workflow.defn` orchestration: `OrderPlacementWorkflow` |
...
`OrderPlacementWorkflow` execution and prints its result. Open the Web UI at
