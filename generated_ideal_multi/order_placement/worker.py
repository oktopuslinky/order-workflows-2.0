"""Worker process for the OrderPlacementWorkflow workflow.
...
with workflow.unsafe.imports_passed_through():
    from workflow import OrderPlacementWorkflow
...
async def main() -> None:
    ...
    worker = Worker(
        ...
        activities=[validate_cart, reserve_inventory, authorise_payment, create_order, release_inventory],
    )
