...
- [x] uses output `order_id` of `order-placement` as input `order_id` — Order Fulfilment requires the order_id produced by Order Placement to initiate the fulfilment process
