...
## Purpose
The Order Fulfilment workflow ships a placed order and captures its payment. It picks, packs, and ships the order, then captures the previously-authorised payment.
